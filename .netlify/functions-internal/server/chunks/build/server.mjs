...
import { defineComponent, shallowRef, h, resolveComponent, computed, hasInjectionContext, inject, toRef, isRef, toValue, getCurrentInstance as getCurrentInstance$1, onServerPrefetch, ref, nextTick, unref, createElementBlock, provide, cloneVNode, defineAsyncComponent, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, shallowReactive, mergeProps, watch, withCtx, createTextVNode, toDisplayString as toDisplayString$1, createBlock, createCommentVNode, openBlock, withModifiers, withDirectives, vModelText, vModelRadio, onErrorCaptured, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, getCurrentScope } from 'vue';
import { H as parseQuery, c as createError$1, I as hasProtocol, J as isScriptProtocol, K as joinURL, L as klona, M as defuFn, N as withQuery, O as sanitizeStatusCode, P as withTrailingSlash, Q as withoutTrailingSlash, R as getContext, $ as $fetch$1, S as baseURL, B as publicAssetsURL, T as createHooks, U as executeAsync, h as getHeader, V as parseURL, W as toRouteMatcher, X as createRouter$1, Y as defu, Z as setCookie, b as getRequestURL, _ as getCookie, a0 as getRequestHeader, F as destr, a1 as createDefu, a2 as isEqual, a3 as parsePath, a4 as deleteCookie } from '../_/nitro.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { createServerClient, parseCookieHeader } from '@supabase/ssr';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrRenderComponent, ssrRenderTeleport, ssrRenderSlot, ssrIncludeBooleanAttr, ssrLooseEqual, ssrRenderStyle, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const __nuxt_page_meta = {
  key: (route2) => String(route2.params.slug || "")
};
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BlJd4ZuT.mjs')
  },
  {
    name: "planos",
    path: "/planos",
    component: () => import('./planos-Cmdho7DA.mjs')
  },
  {
    name: "termos",
    path: "/termos",
    component: () => import('./termos-ASCfCuLG.mjs')
  },
  {
    name: "privacidade",
    path: "/privacidade",
    component: () => import('./privacidade-Bogckn6c.mjs')
  },
  {
    name: "testes",
    path: "/testes",
    component: () => import('./index-Br6QhkPS.mjs')
  },
  {
    name: "artigos",
    path: "/artigos",
    component: () => import('./index-BJ6ZA6XS.mjs')
  },
  {
    name: "auth-callback",
    path: "/auth/callback",
    component: () => import('./callback-BiR2m7rd.mjs')
  },
  {
    name: "testes-slug",
    path: "/testes/:slug()",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./_slug_-C_k13LQg.mjs')
  },
  {
    name: "artigos-slug",
    path: "/artigos/:slug()",
    meta: __nuxt_page_meta || {},
    component: () => import('./_slug_-CNgb-Vjl.mjs')
  },
  {
    name: "testes-historico",
    path: "/testes/historico",
    meta: { "middleware": ["require-auth"] },
    component: () => import('./historico-C-aSIDoP.mjs')
  },
  {
    name: "auth-reset-password",
    path: "/auth/reset-password",
    component: () => import('./reset-password-BD116gHx.mjs')
  },
  {
    name: "resultados-sessionId",
    path: "/resultados/:sessionId()",
    component: () => import('./_sessionId_-3USkJ1Ik.mjs')
  }
];
...
const namedMiddleware = {
  "require-auth": () => import('./require-auth-DyvnfOLX.mjs')
};
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-COBTEazn.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-DDIvAiUU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTableDVue = defineAsyncComponent(() => import('./ProseTable.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-DwOFLzHD.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbodyDVue = defineAsyncComponent(() => import('./ProseTbody.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-C4Ka5XfX.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTdDVue = defineAsyncComponent(() => import('./ProseTd.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-C-udiBBu.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThDVue = defineAsyncComponent(() => import('./ProseTh.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-sTMf36M-.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTheadDVue = defineAsyncComponent(() => import('./ProseThead.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-CLXcSr5N.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTrDVue = defineAsyncComponent(() => import('./ProseTr.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-BEm2pjIn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUlDVue = defineAsyncComponent(() => import('./ProseUl.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-AkjWMFby.mjs').then((r) => r["default"] || r.default || r));
...
const localeLoaders = {
  "pt-BR": [
    {
      key: "locale_pt_45BR_46json_522067c3",
      load: () => import(
        './pt-BR-BdzosbQG.mjs'
        /* webpackChunkName: "locale_pt_45BR_46json_522067c3" */
      ),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_0de83a29",
      load: () => import(
        './en-C68jnG9D.mjs'
        /* webpackChunkName: "locale_en_46json_0de83a29" */
      ),
      cache: true
    }
  ],
  es: [
    {
      key: "locale_es_46json_28f00529",
      load: () => import(
        './es-Rg6mwdbV.mjs'
        /* webpackChunkName: "locale_es_46json_28f00529" */
      ),
      cache: true
    }
  ]
...
const vueI18nConfigs = [
  () => import(
    './i18n.config-BIp1ZiBC.mjs'
    /* webpackChunkName: "config_i18n_46config_46ts_bcce9c12" */
  )
];
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/mjoZES-1"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/mjoZES-1"}/${locale}/messages.json`));
...
function applyHiddenState(el, options) {
  el.style.opacity = "0";
...
const reveal_vSOT7wCJxUvg5ebNsYd9ssVWIaiumAmGHcQWmmG0WEs = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const plugins = [
  ...
  reveal_vSOT7wCJxUvg5ebNsYd9ssVWIaiumAmGHcQWmmG0WEs,
...
const _imports_0 = publicAssetsURL("/logo-512.png");
function getLocaleCode(entry2) {
  return typeof entry2 === "string" ? entry2 : entry2.code;
}
function useI18nUi() {
  const { locale, locales, t } = useI18n();
  const availableLocales = computed(() => {
    const list = Array.isArray(locales.value) ? locales.value : [];
    return list.map((entry2) => {
      const code = getLocaleCode(entry2);
  ...
  async function setLocaleSafe(code) {
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { locale, availableLocales } = useI18nUi();
    const localeValue = computed(() => locale.value);
    function getButtonClass(code) {
      const base = "rounded-full px-2 py-1 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-slate-900";
      const active = "bg-slate-200 text-slate-900 dark:bg-slate-700 dark:text-slate-50";
      const inactive = "text-slate-500 hover:text-indigo-600 dark:text-slate-300 dark:hover:text-amber-300";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(availableLocales), (option) => {
        _push(`<button type="button" role="radio"${ssrRenderAttr("aria-checked", option.code === localeValue.value)}${ssrRenderAttr("aria-current", option.code === localeValue.value ? "true" : void 0)} class="${ssrRenderClass(getButtonClass(option.code))}">${ssrInterpolate(option.label)}</button>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
_sfc_main$c.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/layout/LanguageToggle.vue");
  return _sfc_setup$c ? _sfc_setup$c(props, ctx) : void 0;
};
const LanguageToggle = Object.assign(_sfc_main$c, { __name: "LayoutLanguageToggle" });
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="hidden text-xs font-medium sm:inline">${ssrInterpolate(label.value)}</span></button>`);
    };
  }
});
...
const ThemeToggle = Object.assign(_sfc_main$b, { __name: "LayoutThemeToggle" });
...
function useAuthUi() {
  ...
  const user = computed(() => session.value?.user ?? supabaseUser.value ?? null);
...
const itemClass = "flex w-full items-center justify-between rounded-lg border border-slate-200 bg-white px-3 py-2 text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-slate-600 shadow-sm transition hover:border-indigo-200 hover:text-indigo-700 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 dark:hover:border-amber-300 dark:hover:text-amber-200";
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  emits: ["close", "open-auth", "logout", "toggle-theme"],
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emit = __emit;
    ...
    watch(
      ...
      (open, _, onCleanup) => {
        ...
        onCleanup(() => (void 0).removeEventListener("keydown", onKeydown));
      }
    );
    watch(
      () => route.fullPath,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.open) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed inset-0 z-50 md:hidden" }, _attrs))}><div class="absolute inset-0 bg-slate-900/50 backdrop-blur-sm"></div><div${ssrRenderAttr("id", __props.panelId)} role="dialog" aria-modal="true"${ssrRenderAttr("aria-label", unref(t)("menu.title"))} tabindex="-1" class="absolute right-3 top-3 w-[min(92vw,340px)] rounded-2xl border border-slate-200 bg-white p-4 shadow-xl dark:border-slate-800 dark:bg-slate-900"><div class="flex items-center justify-between"><div class="space-y-1"><p class="text-[0.65rem] font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">${ssrInterpolate(unref(t)("menu.title"))}</p></div><button type="button" class="rounded-full p-1 text-slate-500 transition hover:bg-slate-100 hover:text-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"${ssrRenderAttr("aria-label", unref(t)("common.actions.close"))}>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "mdi:close",
          size: "18",
          "aria-hidden": "true"
        }, null, _parent));
        _push(`</button></div><nav class="mt-4 space-y-2">`);
        if (unref(isLoggedIn)) {
          _push(`<div class="${ssrRenderClass(itemClass)}">${ssrInterpolate(unref(t)("menu.greeting", { name: unref(displayName) }))}</div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(isLoggedIn)) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(unref(t)("menu.items.testsDone"))}`);
              } else {
                return [
                  createTextVNode(toDisplayString$1(unref(t)("menu.items.testsDone")), 1)
                ];
              }
            }),
            _: 1
          ...
          _push(`<button type="button" class="${ssrRenderClass(itemClass)}">${ssrInterpolate(unref(t)("menu.items.testsDone"))}</button>`);
        }
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/artigos",
          class: itemClass,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(t)("menu.items.articles"))}`);
            } else {
              return [
                createTextVNode(toDisplayString$1(unref(t)("menu.items.articles")), 1)
              ];
            }
          }),
          _: 1
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(t)("menu.items.plan"))}`);
            } else {
              return [
                createTextVNode(toDisplayString$1(unref(t)("menu.items.plan")), 1)
              ];
            }
          }),
          _: 1
        ...
        if (!unref(isLoggedIn)) {
          _push(`<button type="button" class="${ssrRenderClass(itemClass)}">${ssrInterpolate(unref(t)("common.actions.enterRegister"))}</button>`);
        } else {
          _push(`<button type="button" class="${ssrRenderClass(itemClass)}">${ssrInterpolate(unref(t)("common.actions.logout"))}</button>`);
        }
        _push(`</nav><div class="mt-4 space-y-3 border-t border-slate-200 pt-3 dark:border-slate-800">`);
        _push(ssrRenderComponent(LanguageToggle, { class: "w-full justify-center" }, null, _parent));
        _push(ssrRenderComponent(ThemeToggle, {
          class: "w-full justify-center",
          theme: __props.theme,
          onToggle: ($event) => emit("toggle-theme")
        }, null, _parent));
        _push(`</div></div></div>`);
      } else {
        _push(`<!---->`);
...
const MobileMenu = Object.assign(_sfc_main$a, { __name: "LayoutMobileMenu" });
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["toggle-theme", "open-auth", "logout"],
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emit = __emit;
    const { isLoggedIn, displayName } = useAuthUi();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$1;
      const _component_Icon = __nuxt_component_1;
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "fixed inset-x-0 top-0 z-40 border-b border-slate-200/80 bg-white/80 backdrop-blur dark:border-slate-800 dark:bg-slate-900/80" }, _attrs))}><div class="mx-auto flex max-w-5xl items-center justify-between gap-4 px-4 py-2">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)}${ssrRenderAttr("alt", unref(t)("common.brand"))} class="h-14 w-14 rounded-full"${_scopeId}><span class="text-xl font-semibold tracking-tight text-slate-900 dark:text-slate-50"${_scopeId}>${ssrInterpolate(unref(t)("common.brand"))}</span>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
              ...
              createVNode("span", { class: "text-xl font-semibold tracking-tight text-slate-900 dark:text-slate-50" }, toDisplayString$1(unref(t)("common.brand")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<nav class="hidden items-center gap-4 text-xs font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400 md:flex">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/artigos",
      ...
      _push(`</nav><div class="flex items-center gap-3"><div class="hidden items-center gap-3 md:flex"><div class="flex items-center gap-2">`);
      if (unref(isLoggedIn)) {
        _push(`<!--[-->`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/testes/historico",
          ...
          "aria-label": unref(t)("menu.items.testsDone"),
          title: unref(t)("menu.items.testsDone")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                createTextVNode(toDisplayString$1(unref(displayName)), 1)
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(`<button type="button" class="rounded-full bg-slate-200 px-3 py-1.5 text-xs font-semibold text-slate-800 shadow-sm transition hover:bg-slate-300 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-700">${ssrInterpolate(unref(t)("common.actions.logout"))}</button><!--]-->`);
      } else {
        _push(`<button type="button" data-cy="open-auth-modal" class="rounded-full bg-indigo-600 px-4 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900/5">${ssrInterpolate(unref(t)("common.actions.enterRegister"))}</button>`);
      }
      _push(`</div>`);
      ...
      _push(`</div><button type="button" class="inline-flex h-9 w-9 items-center justify-center rounded-full border border-slate-200 bg-slate-100 text-slate-700 shadow-sm transition hover:bg-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700 dark:focus-visible:ring-offset-slate-900 md:hidden"${ssrRenderAttr("aria-expanded", isMenuOpen.value)} aria-controls="mobile-menu"${ssrRenderAttr("aria-label", unref(t)("menu.title"))}>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:menu",
        size: "20",
        "aria-hidden": "true"
      ...
      _push(ssrRenderComponent(MobileMenu, {
        ...
        onToggleTheme: ($event) => emit("toggle-theme")
      }, null, _parent));
      _push(`</header>`);
    };
  }
...
const SiteHeader = Object.assign(_sfc_main$9, { __name: "LayoutSiteHeader" });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.modelValue) {
          _push2(`<div class="fixed inset-0 z-40 flex items-center justify-center bg-slate-900/60 px-4 py-6" data-v-dab23996>`);
          if (__props.modelValue) {
            _push2(`<div class="relative w-full max-w-md rounded-2xl bg-white p-5 shadow-xl dark:bg-slate-900" role="dialog" aria-modal="true" data-v-dab23996><button type="button" class="absolute right-3 top-3 rounded-full p-1 text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 dark:hover:bg-slate-800 dark:hover:text-slate-200" aria-label="Fechar" data-v-dab23996> ✕ </button>`);
...
const BaseModal = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$8, [["__scopeId", "data-v-dab23996"]]), { __name: "BaseModal" });
const _sfc_main$7 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: "animate-pulse rounded-lg bg-slate-200/80 dark:bg-slate-800/80",
    "aria-hidden": "true"
  }, _attrs))}></div>`);
}
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/base/SkeletonBlock.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const SkeletonBlock = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender]]), { __name: "BaseSkeletonBlock" });
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["update:open", "close", "submit-email", "google-auth", "reset-password"],
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emit = __emit;
    ...
    const canSubmit = computed(() => {
      ...
      const baseOk = !!name.value && !!email.value && !!password.value && !!passwordConfirm.value && !!gender.value;
      return baseOk && passwordsMatch.value && passwordScore.value >= 2 && password.value.length >= 8;
    });
    ...
    function handleSubmit() {
      ...
      if (mode.value === "signup") {
        ...
        if (passwordScore.value < 2) {
          localError.value = "Use uma senha mais forte (8+ caracteres, letras maiúsculas/minúsculas, números e símbolo).";
          return;
        }
      }
      emit("submit-email", {
        ...
        name: mode.value === "signup" ? name.value : void 0,
        gender: mode.value === "signup" ? gender.value : void 0
      });
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(BaseModal, mergeProps({
        "model-value": internalOpen.value,
        "onUpdate:modelValue": (v) => emit("update:open", v),
        onClose: ($event) => emit("close")
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative space-y-5"${_scopeId}>`);
            if (__props.loading) {
              _push2(`<div class="absolute inset-0 z-10 rounded-2xl bg-white/70 p-4 dark:bg-slate-900/70"${_scopeId}><div class="flex h-full flex-col gap-3"${_scopeId}>`);
              _push2(ssrRenderComponent(SkeletonBlock, { class: "h-4 w-20" }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(SkeletonBlock, { class: "h-6 w-2/3" }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(SkeletonBlock, { class: "h-4 w-full" }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(SkeletonBlock, { class: "h-10 w-full rounded-lg" }, null, _parent2, _scopeId));
              _push2(`</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<header class="space-y-1"${_scopeId}><p class="text-[0.7rem] font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400"${_scopeId}> Acesso </p><h2 class="text-lg font-semibold leading-tight"${_scopeId}>${ssrInterpolate(mode.value === "signin" ? "Entrar na sua conta" : mode.value === "signup" ? "Criar uma conta" : "Recuperar senha")}</h2><p class="text-xs text-slate-500 dark:text-slate-400"${_scopeId}>${ssrInterpolate(mode.value === "reset" ? "Vamos enviar um link para você definir uma nova senha." : "Use seu e-mail ou continue com o Google.")}</p></header>`);
            if (mode.value !== "reset") {
              _push2(`<div class="flex gap-2 rounded-full bg-slate-100 p-1 text-xs dark:bg-slate-800"${_scopeId}><button type="button" class="${ssrRenderClass([
                mode.value === "signin" ? "bg-white text-slate-900 shadow-sm dark:bg-slate-900 dark:text-slate-50" : "text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-100",
                "flex-1 rounded-full px-3 py-1.5 font-medium transition"
              ])}"${_scopeId}> Entrar </button><button type="button" class="${ssrRenderClass([
                mode.value === "signup" ? "bg-white text-slate-900 shadow-sm dark:bg-slate-900 dark:text-slate-50" : "text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-100",
                "flex-1 rounded-full px-3 py-1.5 font-medium transition"
              ])}"${_scopeId}> Cadastrar-se </button></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (resolvedErrorMessage.value) {
              _push2(`<div data-cy="auth-feedback-error" class="rounded-lg bg-red-50 px-3 py-2 text-[0.7rem] text-red-700 dark:bg-red-900/40 dark:text-red-200"${_scopeId}>${ssrInterpolate(resolvedErrorMessage.value)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            if (resolvedSuccessMessage.value) {
              _push2(`<div data-cy="auth-feedback-success" class="rounded-lg bg-emerald-50 px-3 py-2 text-[0.7rem] text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-200"${_scopeId}>${ssrInterpolate(resolvedSuccessMessage.value)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<form class="space-y-4"${_scopeId}>`);
            if (mode.value === "signup") {
              _push2(`<div class="space-y-2"${_scopeId}><label class="block text-xs font-medium text-slate-700 dark:text-slate-200"${_scopeId}> Nome completo <input${ssrRenderAttr("value", name.value)} type="text" class="mt-1 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-900 shadow-sm outline-none ring-indigo-500/0 transition placeholder:text-slate-400 hover:border-slate-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/40 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-50 dark:placeholder:text-slate-500 dark:hover:border-slate-500" autocomplete="name"${_scopeId}></label></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (mode.value === "signup") {
              _push2(`<div class="space-y-1"${_scopeId}><p class="text-xs font-medium text-slate-700 dark:text-slate-200"${_scopeId}> Sexo </p><div class="flex gap-2"${_scopeId}><label class="flex flex-1 items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-[0.7rem] text-slate-700 shadow-sm transition hover:border-slate-300 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:hover:border-slate-500"${_scopeId}><input${ssrIncludeBooleanAttr(ssrLooseEqual(gender.value, "male")) ? " checked" : ""} type="radio" value="male" class="h-3 w-3 border-slate-300 text-indigo-600 focus:ring-indigo-500"${_scopeId}><span${_scopeId}>Masculino</span></label><label class="flex flex-1 items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-[0.7rem] text-slate-700 shadow-sm transition hover:border-slate-300 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:hover:border-slate-500"${_scopeId}><input${ssrIncludeBooleanAttr(ssrLooseEqual(gender.value, "female")) ? " checked" : ""} type="radio" value="female" class="h-3 w-3 border-slate-300 text-indigo-600 focus:ring-indigo-500"${_scopeId}><span${_scopeId}>Feminino</span></label></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="space-y-2"${_scopeId}><label class="block text-xs font-medium text-slate-700 dark:text-slate-200"${_scopeId}> E-mail <input${ssrRenderAttr("value", email.value)} type="email" required${ssrRenderAttr("data-cy", mode.value === "reset" ? "auth-reset-email" : "auth-email")} class="mt-1 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-900 shadow-sm outline-none ring-indigo-500/0 transition placeholder:text-slate-400 hover:border-slate-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/40 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-50 dark:placeholder:text-slate-500 dark:hover:border-slate-500" autocomplete="email"${_scopeId}></label></div>`);
            if (mode.value !== "reset") {
              _push2(`<div class="space-y-2"${_scopeId}><label class="block text-xs font-medium text-slate-700 dark:text-slate-200"${_scopeId}> Senha <input${ssrRenderAttr("value", password.value)} type="password" required minlength="8" data-cy="auth-password" class="mt-1 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-900 shadow-sm outline-none ring-indigo-500/0 transition placeholder:text-slate-400 hover:border-slate-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/40 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-50 dark:placeholder:text-slate-500 dark:hover:border-slate-500"${ssrRenderAttr("autocomplete", mode.value === "signin" ? "current-password" : "new-password")}${_scopeId}></label>`);
              if (mode.value === "signin") {
                _push2(`<div class="flex justify-end"${_scopeId}><button type="button" data-cy="auth-forgot-password" class="text-[0.7rem] font-medium text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300"${_scopeId}> Esqueci minha senha </button></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            if (mode.value === "signup") {
              _push2(`<div class="space-y-2"${_scopeId}><label class="block text-xs font-medium text-slate-700 dark:text-slate-200"${_scopeId}> Confirmar senha <input${ssrRenderAttr("value", passwordConfirm.value)} type="password" required minlength="8" class="mt-1 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-900 shadow-sm outline-none ring-indigo-500/0 transition placeholder:text-slate-400 hover:border-slate-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/40 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-50 dark:placeholder:text-slate-500 dark:hover:border-slate-500" autocomplete="new-password"${_scopeId}></label><div class="space-y-1"${_scopeId}><div class="flex items-center justify-between text-[0.65rem]"${_scopeId}><span${_scopeId}> Força da senha: <span class="${ssrRenderClass(["font-semibold", strengthLabelClass.value])}"${_scopeId}>${ssrInterpolate(passwordStrengthLabel.value)}</span></span>`);
              if (password.value && passwordConfirm.value && !passwordsMatch.value) {
                _push2(`<span class="text-[0.65rem] text-red-500"${_scopeId}> As senhas não coincidem </span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="h-1 w-full rounded-full bg-slate-200 dark:bg-slate-800"${_scopeId}><div class="${ssrRenderClass([strengthBarClass.value, "h-1 rounded-full transition-all"])}" style="${ssrRenderStyle({ width: strengthBarWidth.value })}"${_scopeId}></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (mode.value === "reset") {
              _push2(`<div class="flex justify-end"${_scopeId}><button type="button" class="text-[0.7rem] font-medium text-slate-600 hover:text-slate-800 dark:text-slate-300 dark:hover:text-slate-100"${_scopeId}> Voltar para login </button></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<button type="submit"${ssrRenderAttr("data-cy", mode.value === "reset" ? "auth-reset-submit" : "auth-submit")} class="flex w-full items-center justify-center rounded-lg bg-indigo-600 px-3 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900/5 disabled:cursor-not-allowed disabled:opacity-60"${ssrIncludeBooleanAttr(__props.loading || !canSubmit.value) ? " disabled" : ""}${_scopeId}>`);
            if (__props.loading) {
              _push2(`<span${_scopeId}>Processando...</span>`);
            } else {
              _push2(`<span${_scopeId}>${ssrInterpolate(mode.value === "signin" ? "Entrar" : mode.value === "signup" ? "Criar conta" : "Enviar link de recuperação")}</span>`);
            }
            _push2(`</button>`);
            if (mode.value !== "reset") {
              _push2(`<div class="flex items-center gap-2"${_scopeId}><div class="h-px flex-1 bg-slate-200 dark:bg-slate-800"${_scopeId}></div><span class="text-[0.65rem] uppercase tracking-[0.15em] text-slate-400"${_scopeId}> ou </span><div class="h-px flex-1 bg-slate-200 dark:bg-slate-800"${_scopeId}></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (mode.value !== "reset") {
              _push2(`<button type="button" class="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-800 shadow-sm transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-50 dark:hover:bg-slate-800"${ssrIncludeBooleanAttr(__props.loading) ? " disabled" : ""}${_scopeId}><span class="inline-flex h-4 w-4 items-center justify-center rounded-sm bg-white text-[0.6rem] leading-none text-slate-900 shadow dark:bg-slate-200"${_scopeId}> G </span><span${_scopeId}>${ssrInterpolate(mode.value === "signin" ? "Continuar com Google" : "Cadastrar com Google")}</span></button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<p class="text-[0.65rem] leading-snug text-slate-400"${_scopeId}> Ao continuar, você concorda com os termos de uso e com a política de privacidade do Speculum Animae. </p></form></div>`);
          } else {
            return [
              createVNode("div", { class: "relative space-y-5" }, [
                __props.loading ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "absolute inset-0 z-10 rounded-2xl bg-white/70 p-4 dark:bg-slate-900/70"
                }, [
                  createVNode("div", { class: "flex h-full flex-col gap-3" }, [
                    createVNode(SkeletonBlock, { class: "h-4 w-20" }),
                    createVNode(SkeletonBlock, { class: "h-6 w-2/3" }),
                    createVNode(SkeletonBlock, { class: "h-4 w-full" }),
                    createVNode(SkeletonBlock, { class: "h-10 w-full rounded-lg" })
                  ])
                ])) : createCommentVNode("", true),
                createVNode("header", { class: "space-y-1" }, [
                  createVNode("p", { class: "text-[0.7rem] font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400" }, " Acesso "),
                  createVNode("h2", { class: "text-lg font-semibold leading-tight" }, toDisplayString$1(mode.value === "signin" ? "Entrar na sua conta" : mode.value === "signup" ? "Criar uma conta" : "Recuperar senha"), 1),
                  createVNode("p", { class: "text-xs text-slate-500 dark:text-slate-400" }, toDisplayString$1(mode.value === "reset" ? "Vamos enviar um link para você definir uma nova senha." : "Use seu e-mail ou continue com o Google."), 1)
                ]),
                mode.value !== "reset" ? (openBlock(), createBlock("div", {
                  key: 1,
                  ...
                  createVNode("button", {
                    ...
                    onClick: ($event) => switchMode("signin")
                  }, " Entrar ", 10, ["onClick"]),
                  createVNode("button", {
                    type: "button",
                    class: [
                    ...
                    onClick: ($event) => switchMode("signup")
                  }, " Cadastrar-se ", 10, ["onClick"])
                ])) : createCommentVNode("", true),
                resolvedErrorMessage.value ? (openBlock(), createBlock("div", {
                  key: 2,
                ...
                }, toDisplayString$1(resolvedErrorMessage.value), 1)) : createCommentVNode("", true),
                resolvedSuccessMessage.value ? (openBlock(), createBlock("div", {
                  key: 3,
                ...
                }, toDisplayString$1(resolvedSuccessMessage.value), 1)) : createCommentVNode("", true),
                createVNode("form", {
                  class: "space-y-4",
                  onSubmit: withModifiers(handleSubmit, ["prevent"])
                }, [
                  mode.value === "signup" ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "space-y-2"
                  }, [
                    createVNode("label", { class: "block text-xs font-medium text-slate-700 dark:text-slate-200" }, [
                  ...
                  mode.value === "signup" ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("p", { class: "text-xs font-medium text-slate-700 dark:text-slate-200" }, " Sexo "),
                    createVNode("div", { class: "flex gap-2" }, [
                      createVNode("label", { class: "flex flex-1 items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-[0.7rem] text-slate-700 shadow-sm transition hover:border-slate-300 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:hover:border-slate-500" }, [
                        withDirectives(createVNode("input", {
                          ...
                          [vModelRadio, gender.value]
                        ]),
                        createVNode("span", null, "Masculino")
                      ]),
                      createVNode("label", { class: "flex flex-1 items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-[0.7rem] text-slate-700 shadow-sm transition hover:border-slate-300 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:hover:border-slate-500" }, [
                        withDirectives(createVNode("input", {
                          "onUpdate:modelValue": ($event) => gender.value = $event,
                        ...
                        createVNode("span", null, "Feminino")
                      ])
                    ])
                  ])) : createCommentVNode("", true),
                  createVNode("div", { class: "space-y-2" }, [
                    createVNode("label", { class: "block text-xs font-medium text-slate-700 dark:text-slate-200" }, [
                      ...
                      withDirectives(createVNode("input", {
                        ...
                        type: "email",
                        required: "",
                        "data-cy": mode.value === "reset" ? "auth-reset-email" : "auth-email",
                        class: "mt-1 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-900 shadow-sm outline-none ring-indigo-500/0 transition placeholder:text-slate-400 hover:border-slate-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/40 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-50 dark:placeholder:text-slate-500 dark:hover:border-slate-500",
                        autocomplete: "email"
                      }, null, 8, ["onUpdate:modelValue", "data-cy"]), [
                  ...
                  mode.value !== "reset" ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("label", { class: "block text-xs font-medium text-slate-700 dark:text-slate-200" }, [
                      ...
                      withDirectives(createVNode("input", {
                        ...
                        class: "mt-1 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-900 shadow-sm outline-none ring-indigo-500/0 transition placeholder:text-slate-400 hover:border-slate-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/40 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-50 dark:placeholder:text-slate-500 dark:hover:border-slate-500",
                        autocomplete: mode.value === "signin" ? "current-password" : "new-password"
                      }, null, 8, ["onUpdate:modelValue", "autocomplete"]), [
                        [vModelText, password.value]
                      ])
                    ]),
                    mode.value === "signin" ? (openBlock(), createBlock("div", {
                      key: 0,
                      ...
                      createVNode("button", {
                        ...
                        onClick: ($event) => switchMode("reset")
                      }, " Esqueci minha senha ", 8, ["onClick"])
                    ])) : createCommentVNode("", true)
                  ])) : createCommentVNode("", true),
                  mode.value === "signup" ? (openBlock(), createBlock("div", {
                    key: 3,
                    ...
                    createVNode("label", { class: "block text-xs font-medium text-slate-700 dark:text-slate-200" }, [
                      ...
                      withDirectives(createVNode("input", {
                        ...
                        [vModelText, passwordConfirm.value]
                      ])
                    ]),
                    createVNode("div", { class: "space-y-1" }, [
                      createVNode("div", { class: "flex items-center justify-between text-[0.65rem]" }, [
                        createVNode("span", null, [
                          createTextVNode(" Força da senha: "),
                          createVNode("span", {
                            class: ["font-semibold", strengthLabelClass.value]
                          }, toDisplayString$1(passwordStrengthLabel.value), 3)
                        ]),
                        password.value && passwordConfirm.value && !passwordsMatch.value ? (openBlock(), createBlock("span", {
                          key: 0,
                          class: "text-[0.65rem] text-red-500"
                        }, " As senhas não coincidem ")) : createCommentVNode("", true)
                      ]),
                      createVNode("div", { class: "h-1 w-full rounded-full bg-slate-200 dark:bg-slate-800" }, [
                        createVNode("div", {
                          class: ["h-1 rounded-full transition-all", strengthBarClass.value],
                          style: { width: strengthBarWidth.value }
                        }, null, 6)
                      ])
                    ])
                  ])) : createCommentVNode("", true),
                  mode.value === "reset" ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("button", {
                      ...
                      onClick: ($event) => switchMode("signin")
                    }, " Voltar para login ", 8, ["onClick"])
                  ])) : createCommentVNode("", true),
                  createVNode("button", {
                    type: "submit",
                    "data-cy": mode.value === "reset" ? "auth-reset-submit" : "auth-submit",
                    class: "flex w-full items-center justify-center rounded-lg bg-indigo-600 px-3 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900/5 disabled:cursor-not-allowed disabled:opacity-60",
                    disabled: __props.loading || !canSubmit.value
                  }, [
                    __props.loading ? (openBlock(), createBlock("span", { key: 0 }, "Processando...")) : (openBlock(), createBlock("span", { key: 1 }, toDisplayString$1(mode.value === "signin" ? "Entrar" : mode.value === "signup" ? "Criar conta" : "Enviar link de recuperação"), 1))
                  ], 8, ["data-cy", "disabled"]),
                  mode.value !== "reset" ? (openBlock(), createBlock("div", {
                    key: 5,
                    class: "flex items-center gap-2"
                  }, [
                    createVNode("div", { class: "h-px flex-1 bg-slate-200 dark:bg-slate-800" }),
                    createVNode("span", { class: "text-[0.65rem] uppercase tracking-[0.15em] text-slate-400" }, " ou "),
                    createVNode("div", { class: "h-px flex-1 bg-slate-200 dark:bg-slate-800" })
                  ])) : createCommentVNode("", true),
                  mode.value !== "reset" ? (openBlock(), createBlock("button", {
                    key: 6,
                    type: "button",
                    ...
                    createVNode("span", { class: "inline-flex h-4 w-4 items-center justify-center rounded-sm bg-white text-[0.6rem] leading-none text-slate-900 shadow dark:bg-slate-200" }, " G "),
                    createVNode("span", null, toDisplayString$1(mode.value === "signin" ? "Continuar com Google" : "Cadastrar com Google"), 1)
                  ], 8, ["disabled"])) : createCommentVNode("", true),
                  createVNode("p", { class: "text-[0.65rem] leading-snug text-slate-400" }, " Ao continuar, você concorda com os termos de uso e com a política de privacidade do Speculum Animae. ")
                ], 32)
              ])
            ];
          }
...
const AuthModal = Object.assign(_sfc_main$6, { __name: "AuthModal" });
const useSupabaseClient = () => {
  return useNuxtApp().$supabase.client;
};
function mapAuthErrorMessage(code, message) {
  switch (code) {
...
function useAuthModal() {
  const isAuthOpen = useState("auth-modal-open", () => false);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$1;
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "mt-10 border-t border-slate-200 bg-white/80 text-slate-800 backdrop-blur-sm dark:border-slate-800 dark:bg-slate-950/90 dark:text-slate-100" }, _attrs))}><div class="mx-auto flex max-w-5xl flex-col gap-6 px-4 py-8 md:flex-row md:items-start md:justify-between"><section class="space-y-3 md:max-w-xl"><div class="space-y-1"><p class="text-sm font-semibold tracking-[0.16em] text-slate-500 dark:text-slate-400">${ssrInterpolate(unref(t)("common.brand").toUpperCase())}</p></div><figure class="rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-sm italic text-slate-700 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200"><blockquote class="leading-relaxed"> Conhece a ti mesmo, e a tuas falhas, e assim viverás. </blockquote><figcaption class="mt-1 text-xs not-italic text-slate-500 dark:text-slate-400"> (Santo Agostinho) </figcaption></figure></section><section class="space-y-2"><p class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">${ssrInterpolate(unref(t)("footer.legalContact"))}</p><div class="flex flex-wrap items-center gap-3">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/termos",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(toDisplayString$1(unref(t)("footer.terms")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(toDisplayString$1(unref(t)("footer.privacy")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<a${ssrRenderAttr("href", `mailto:${contactEmail}`)} class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-amber-300 transition">${ssrInterpolate(unref(t)("footer.contact"))}</a></div></section></div><div class="border-t border-slate-200 px-4 py-4 text-center text-[11px] text-slate-500 dark:border-slate-800 dark:text-slate-500"><p> © ${ssrInterpolate(unref(t)("footer.copyright", { year: unref(currentYear) }))}</p></div></footer>`);
    };
  }
});
...
const SiteFooter = Object.assign(_sfc_main$5, { __name: "LayoutSiteFooter" });
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useSeoMeta(() => ({
      titleTemplate: (t2) => t2 ? `${t2} | Speculum Animae` : "Speculum Animae",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-slate-50 text-slate-900 transition-colors dark:bg-slate-950 dark:text-slate-50 pt-8" }, _attrs))}>`);
      _push(ssrRenderComponent(SiteHeader, {
        theme: unref(theme),
        onToggleTheme: toggleTheme,
        onOpenAuth: unref(openAuthModal),
        onLogout: handleLogout
      }, null, _parent));
      _push(ssrRenderComponent(AuthModal, {
        open: unref(isAuthOpen),
        loading: authLoading.value,
        "error-message": authError.value,
        "reset-feedback": resetFeedback.value,
        "onUpdate:open": unref(setAuthModal),
        onClose: unref(closeAuthModal),
        onSubmitEmail: handleEmailAuth,
        onGoogleAuth: handleGoogleAuth,
        onResetPassword: handleResetPassword
      }, null, _parent));
      _push(`<main class="mx-auto max-w-5xl px-4 py-10">`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        ...
        class: ["btn-base", variantClass.value]
      }, _ctx.$attrs, _attrs))} data-v-88f55c7c>`);
      if (props.variant === "gradient") {
        _push(`<span class="btn-gradient__inner" data-v-88f55c7c>`);
...
const BaseButton = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-88f55c7c"]]), { __name: "BaseButton" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-white/95 via-slate-50/90 to-indigo-50/80 p-6 shadow-sm dark:border-slate-800 dark:from-slate-950 dark:via-slate-900/80 dark:to-slate-950 sm:p-8" }, _attrs))}><div class="pointer-events-none absolute -right-16 -top-16 h-40 w-40 rounded-full bg-indigo-200/40 blur-3xl dark:bg-amber-400/10"></div><div class="pointer-events-none absolute -left-20 bottom-0 h-36 w-36 rounded-full bg-slate-200/60 blur-3xl dark:bg-slate-800/60"></div><div class="relative space-y-4">`);
      if (__props.statusLabel) {
        _push(`<p class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">${ssrInterpolate(__props.statusLabel)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<h1 class="font-display text-2xl tracking-tight text-slate-900 dark:text-slate-50 sm:text-3xl">${ssrInterpolate(__props.title)}</h1><p class="text-sm text-slate-600 dark:text-slate-300">${ssrInterpolate(__props.description)}</p>`);
      if (_ctx.$slots.actions) {
        _push(`<div class="flex flex-wrap items-center gap-3 pt-2">`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/errors/ErrorShell.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const ErrorShell = Object.assign(_sfc_main$2, { __name: "ErrorsErrorShell" });
const primaryLinkClass = "inline-flex items-center justify-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:bg-amber-300 dark:text-slate-900 dark:hover:bg-amber-200 dark:focus-visible:ring-amber-300/80 dark:focus-visible:ring-offset-slate-950";
const secondaryLinkClass = "inline-flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-indigo-200 hover:text-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:border-amber-300 dark:hover:text-amber-200 dark:focus-visible:ring-amber-300/80 dark:focus-visible:ring-offset-slate-950";
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$1;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-4xl" }, _attrs))}>`);
      _push(ssrRenderComponent(ErrorShell, {
        title: errorTitle.value,
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (isNotFound.value) {
              ...
              if (unref(isLoggedIn)) {
                _push2(ssrRenderComponent(BaseButton, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(` Ir para meus testes `);
                    } else {
                      return [
                        createTextVNode(" Ir para meus testes ")
                      ];
                    }
                  }),
                  _: 1
                ...
                _push2(ssrRenderComponent(BaseButton, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(` Entrar / Cadastrar `);
                    } else {
                      return [
                        createTextVNode(" Entrar / Cadastrar ")
                      ];
                    }
                  }),
                  _: 1
            ...
            return [
              isNotFound.value ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                createVNode(_component_NuxtLink, {
                  to: "/",
                  class: primaryLinkClass,
                  onClick: withModifiers(goHome, ["prevent"])
                }, {
                  default: withCtx(() => [
                    createTextVNode(" Voltar para a home ")
                  ]),
                ...
                createVNode(_component_NuxtLink, {
                  to: "/testes",
                  class: secondaryLinkClass,
                  onClick: withModifiers(goToTests, ["prevent"])
                }, {
                  default: withCtx(() => [
                    createTextVNode(" Ver testes ")
                  ]),
              ...
              ], 64)) : isForbidden.value ? (openBlock(), createBlock(Fragment, { key: 1 }, [
                unref(isLoggedIn) ? (openBlock(), createBlock(BaseButton, {
                  key: 0,
                  type: "button",
                  onClick: goToHistory
                }, {
...
export { BaseButton as B, SkeletonBlock as S, __nuxt_component_0$1 as _, useSeoMeta as a, useHead as b, __nuxt_component_1 as c, useRoute as d, entry_default as default, useSupabaseUser as e, useLazyAsyncData as f, _export_sfc as g, useSupabaseClient as h, useRouter as i, createError as j, useAsyncData as k, useRuntimeConfig as l, defineNuxtRouteMiddleware as m, navigateTo as n, useNuxtApp as o, useRequestEvent as p, useI18n as u };
