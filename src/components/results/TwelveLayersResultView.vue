  ...
  <section class="mx-auto flex max-w-6xl gap-8 px-4 py-10">
    ...
    <div class="flex-1 space-y-8">
      ...
      >
        ...
        <div class="mt-4 space-y-3">
          <div v-for="point in report.traits.graph" :key="point.label" class="space-y-1">
    ...
    >
      ...
      <nav class="mt-3 space-y-1 text-sm">
        <ResultsSidebarLink href="#overview" label="Resumo geral" number="1" />
        <ResultsSidebarLink href="#traits" label="Traços de personalidade" number="2" />
